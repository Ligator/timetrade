...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference("Ranking.count") do
      post rankings_url, params: { ranking: { comment: @ranking.comment, evaluated_id: @ranking.evaluated_id, evaluator_id: @ranking.evaluator_id, score: @ranking.score, task_id: @ranking.task_id } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { comment: @ranking.comment, evaluated_id: @ranking.evaluated_id, evaluator_id: @ranking.evaluator_id, score: @ranking.score, task_id: @ranking.task_id } }
