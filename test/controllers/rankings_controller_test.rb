...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference("Ranking.count") do
      post rankings_url, params: { ranking: { beneficiary_id: @ranking.beneficiary_id, comment: @ranking.comment, score: @ranking.score, supplier_id: @ranking.supplier_id, task_id: @ranking.task_id } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { beneficiary_id: @ranking.beneficiary_id, comment: @ranking.comment, score: @ranking.score, supplier_id: @ranking.supplier_id, task_id: @ranking.task_id } }
